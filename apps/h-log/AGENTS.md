...
- Database: PostgreSQL + pgvector schema migration and the minimal blog repository are implemented; the DB-backed public read path is the next `blog-runtime-integration` step
