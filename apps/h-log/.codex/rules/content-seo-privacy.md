...
2026-08-11 경력 콘텐츠 정합성 결정:

- 사용자가 제공한 경력기술서는 성과 근거 확인에만 사용하고 저장소나 공개 다운로드에 추가하지 않는다.
- 조직 식별자를 제거한 뒤 근거가 확인된 구현 시간, 응답 시간, 처리량, 복구 시간 수치만 Portfolio와 Resume에 공개한다.
- GitHub Issues·Discord 자동화는 경력 프로젝트가 아닌 개인 프로젝트로 명시한다.
